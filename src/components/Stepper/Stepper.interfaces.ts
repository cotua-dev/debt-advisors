import type { MultipleChoiceValues, StepperType, StepTypes } from './Stepper.types';
import type { UserPurpose, DebtType, BehindPaymentsType, FallBehindReason, Questions } from './Stepper.enums';
