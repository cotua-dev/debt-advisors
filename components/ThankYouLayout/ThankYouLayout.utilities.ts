...
export function insertTrackingScripts() {
    ...
    if (headEl !== null) {
        ...
        let facebookPixelScript: HTMLElement | null = document.getElementById("facebook-track-submit-application");
        if (facebookPixelScript === null) {
            facebookPixelScript = document.createElement("script");
            facebookPixelScript.id = "facebook-track-submit-application";
            ...
            facebookPixelScript.append(`
                ...
                fbq("trackSingle", "1011657849590069", "SubmitApplication", {
                    ...
                    currency: "USD",
                    value: ${Number(amount) || 0},
                    predicted_ltv: ${Number(amount) || 0},
                }, { eventID: "submit_application_${uuid || new Date().getTime()}" });
                fbq("trackSingleCustom", "1011657849590069", "ClickCeaseInvalidUsersLive", {
