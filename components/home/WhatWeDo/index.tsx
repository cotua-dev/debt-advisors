    ...
    return (
        <section className={styles['what-we-do']}>
            ...
            <p className={styles['what-we-do-content']}>
                {`Debt Advisors of America helps individuals across the U.S. by creating personalized debt relief programs that work. Our service is a form of debt consolidation without a loan. Our customized plans aim to help you reduce what you owe, avoid filing for bankruptcy, and finally overcome overwhelming debt.`}
            </p>
